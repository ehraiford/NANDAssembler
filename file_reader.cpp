...
class FileReader {
    ...
    public:
        ...
        FileReader(std::string file_path) : instructions_read(-1) {
...
bool is_label(std::string line) {
   auto first = non_space_char(line, First);
   auto last = non_space_char(line, Last);
